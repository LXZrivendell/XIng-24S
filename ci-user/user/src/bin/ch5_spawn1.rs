...
/// 理想输出：
/// new child i
/// Test wait OK84082852733355531910260!
/// Test waitpid OK84082852733355531910260!
...
pub fn main() -> i32 {
    ...
    println!("Test wait OK84082852733355531910260!");
    ...
    assert_eq!(exit_code, 66778, "error exit code");
    println!("Test waitpid OK84082852733355531910260!");
    0
}
