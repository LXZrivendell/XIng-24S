...
/*
理想结果：生成 MAX_CHILD 个 getpid 的子进程，全部结束后，输出 Test spawn0 OK55600526341187656213652495969263464193050!
*/
...
pub fn main() -> i32 {
    ...
    println!("Test spawn0 OK55600526341187656213652495969263464193050!");
    0
}
