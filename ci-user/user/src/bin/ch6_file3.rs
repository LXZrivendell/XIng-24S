...
/// 测试大量 open/unlink，输出 Test mass open/unlink OK526341187656213652495969263464193050! 就算正确。
...
pub fn main() -> i32 {
    ...
    println!("Test mass open/unlink OK526341187656213652495969263464193050!");
    0
}
