...
EXPECTED_8 = EXPECTED_6b + [
    ...
    # ch8_deadlock_mutex1
    "deadlock test mutex 1 OK29142!",

    # ch8_deadlock_sem1
    "deadlock test semaphore 1 OK29142!",

    # ch8_deadlock_sem2
    "deadlock test semaphore 2 OK29142!",
]

EXPECTED_8 = list(set(EXPECTED_8) - set(["Test sbrk almost OK29142!"]))
