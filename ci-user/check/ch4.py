...
EXPECTED_4 = EXPECTED_3 + [
    # ch4_mmap0
    "Test 04_1 OK526341187656213652495969263464193050!",

    # ch4_mmap3
    "Test 04_4 test OK526341187656213652495969263464193050!",

    # ch4_unmap
    "Test 04_5 ummap OK526341187656213652495969263464193050!",

    # ch4_unmap2
    "Test 04_6 ummap2 OK526341187656213652495969263464193050!",
]
