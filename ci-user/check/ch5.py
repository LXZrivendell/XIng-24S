...
EXPECTED_5 = EXPECTED_4 + [
    # ch5_spawn0
    "Test spawn0 OK44866421285257429142!",

    # ch5_spawn1
    "Test wait OK44866421285257429142!",
    "Test waitpid OK44866421285257429142!",

    # ch5_setprio
    "Test set_priority OK44866421285257429142!",
]

EXPECTED_5 = list(set(EXPECTED_5) - set([
    "string from task info test",
    "Test task info OK44866421285257429142!",
]))
